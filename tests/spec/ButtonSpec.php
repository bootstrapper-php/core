...
class ButtonSpec extends ObjectBehavior
{
     ...
     */
    function it_can_append_an_icon($icon)
    {
        $icon->render()->willReturn(
            "<span class='glyphicon glyphicon-bar'></span>"
        );

        $this->appendIcon($icon)->render()->shouldBe(
     ...
     * @param \Bootstrapper\Icon $icon
     */
    function it_can_append_an_icon_with_a_value($icon)
    {
        $icon->render()->willReturn(
            "<span class='glyphicon glyphicon-bar'></span>"
        );

        $this->withValue('foo')->appendIcon($icon)->render()->shouldBe(
     ...
     * @param \Bootstrapper\Icon $icon
     */
    function it_can_be_given_a_prepended_icon($icon)
    {
        $icon->render()->willReturn(
            "<span class='glyphicon glyphicon-bar'></span>"
        );

        $this->prependIcon($icon)->render()->shouldBe(
            "<button type='button' class='btn btn-default'><span class='glyphicon glyphicon-bar'></span></button>"
        );
    }
    ...
    function it_can_be_given_a_prepended_icon_and_a_value($icon)
    {
        ...
        $this->withValue('foo')->prependIcon($icon)->render()->shouldBe(
