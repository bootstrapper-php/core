...
use Bootstrapper\Interfaces\HomeUrlGeneratorInterface;
...
class NavbarSpec extends ObjectBehavior
{
    ...
    /**
     * @param \Bootstrapper\Interfaces\HomeUrlGeneratorInterface $generator
     */
     ...
     * @param \Bootstrapper\Interfaces\HomeUrlGeneratorInterface $generator
     */
    function it_defaults_to_the_root_page_when_branding($generator)
    {
        $generator->getUrlForHomePath('/')->willReturn('http://localhost');
     ...
     * @param \Bootstrapper\Interfaces\HomeUrlGeneratorInterface $generator
     */
    function it_doesnt_require_the_brand_link_for_an_image($generator)
    {
        $generator->getUrlForHomePath('/')->willReturn('http://localhost');
