...
class Navigation extends RenderedObject
{
    ...
    /**
     * @var CurrentUrlInterface A class that can tell us what the current URL is
     */
    protected $url;
     ...
     *
     * @param CurrentUrlInterface $url
     */
    public function __construct(CurrentUrlInterface $url)
    {
        $this->url = $url;
    }
    ...
    protected function itemShouldBeActive($link)
    {
        ...
        $auto = $this->autoroute && $this->url->getCurrentUrl() == $link['link'];
