...
use Bootstrapper\Interfaces\CurrentUrlInterface;
...
class Navbar extends RenderedObject
{
    ...
    /**
     * @var HomeUrlGeneratorInterface A URL generator
     */
    protected $url;
     ...
     *
*@param HomeUrlGeneratorInterface $url
     */
    public function __construct(HomeUrlGeneratorInterface $url)
    {
        $this->url = $url;
    }
    ...
    {
        if (!isset($link)) {
            $link = $this->url->getUrlForHomePath('/');
        }
