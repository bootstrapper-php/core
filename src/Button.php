...
class Button extends RenderedObject
{
    ...
    /**
     * @var Icon The icon, if one should be used
     */
    protected $icon;
     ...
     * @return $this
     */
    public function withIcon(Icon $icon, $append = true)
    {
        $this->icon = $icon;
     ...
     * @return $this
     */
    public function appendIcon(Icon $icon)
    {
     ...
     * @return $this
     */
    public function prependIcon(Icon $icon)
    {
    ...
    protected function getValueWithIcon()
    {
        ...
        if ($this->appendIcon) {
            return $this->value ? "{$this->value} {$icon}" : $icon;
        } else {
            return $this->value ? "{$icon} {$this->value}" : $icon;
        }
    }
}
