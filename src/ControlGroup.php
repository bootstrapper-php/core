...
class ControlGroup extends RenderedObject
{
     ...
     *
     * @param FormInterface $formBuilder An instance of the Bootstrapper form builder
     */
    public function __construct(FormInterface $formBuilder)
    {
    ...
    protected function renderArrayContents()
    {
        ...
        foreach ($this->contents as $item) {
            if (isset($item['label'])) {
                $string .= $this->formBuilder->create('label', $item['label']) . ' ';
            }
            ...
            $string .= $this->formBuilder->create($type, $input_args);
